                    ...
                    <div class="card card-primary card-outline shadow border-0 rounded-lg">
                        ...
                        <div class="card-body">
                            <div class="row text-center">
                                ...
                                <!-- Current Stock -->
                                <div class="col-lg-3 col-md-6 mb-3">
                                    <a href="set_opening_balance-{{ $item->id }}"
                                ...
                                <div class="col-lg-3 col-md-6 mb-3">
                                    <button type="button" class="btn btn-info btn-block p-4 rounded-lg shadow-sm"
                                        data-toggle="modal" data-target="#modal-lgplan-{{ $item->id }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="card card-primary">
                                            ...
                                            <div>
                                                <form action="{{ route('purchase-plan.move', $item->id) }}" method="POST">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-6">
