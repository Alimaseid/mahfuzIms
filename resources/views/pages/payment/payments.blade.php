           ...
           <div class="col-md-12">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    @endphp
                        <tr>
                             <td>{{$no}}</td>
                             <td>{{$payment->date}}</td>
                             <td ><a href="" data-toggle="modal" style="color: rgb(7, 161, 233)" data-target="#modal-lg-view-{{$payment->narration}}">{{number_format($payment->debit,2)}}</a></td>
                             <td>{{number_format($payment->credit,2)}}</td>
                             <td>
                             @if ($payment->debit > 0)
                               <i class="fa fa-arrow-up sm" style="color:red"  data-toggle="modal"  data-target="#modal-lg-view-{{$payment->narration}}"></i>
                             @else
                               <i class="fa fa-arrow-down sm" style="color:green"  data-toggle="modal" style="color: rgb(7, 161, 233)" data-target="#modal-lg-edit-{{$payment->id}}"></i>
                             @endif
                               &nbsp; &nbsp;
                        ...
                        <div class="modal fade" id="modal-lg-edit-{{$payment->id}}">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title">Edit <i class="text-info">{{$customer}}'s </i>Payment.</h4>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <form  action="/editCustomerPayment-{{$payment->id}}" method="POST" id="quickForm" enctype="multipart/form-data">
                                                    @csrf
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-6" >
                                                            <div class="form-group">
                                                              <label for="exampleInputEmail1">Payment Type</label>
                                                               <select name="payment_type" class="form-control" required>
                                                                <option value="{{ Illuminate\Support\Str::before($payment->voucher_type,',')}}">{{ Illuminate\Support\Str::before($payment->voucher_type,',')}}</option>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label >Amount</label>
                                                                <input type="number" step="any" name="amount" class="form-control"  value="{{$payment->credit}}" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="bank" class="form-control" id="cheque" >
                                                                    <option value="{{ Illuminate\Support\Str::after($payment->voucher_type,',')}}">{{ Illuminate\Support\Str::after($payment->voucher_type,',')}}</option>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="cheque_no" class="form-control"  value="{{$payment->refrence_no}}" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="form-group">
                                                                <label >Bank Receipt / cheque</label>
                                                                <p>Open File <a href="/{{$payment->voucher_no}}">View Here</a>.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
              ...
              <div class="modal fade" id="modal-lg">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">New payment By <i class="text-info">{{$customer}}</i></h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card card-primary">
                                    ...
                                    <form  action="/Payment-{{$lastBalance->customer_id}}" method="POST" id="quickForm" enctype="multipart/form-data">
                                        @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-6" >
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label >Amount</label>
                                                    <input type="number" step="any" name="amount" class="form-control"  value="{{$lastBalance->running_balance}}" >
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="modal fade" id="modal-lg-view-{{$salesOrder->id}}">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        <div class="modal-header">
                          <p>
                          <small> Date:</small>  <i class="text-info" >{{$salesOrder->created_at->toDateString() }}</i>&nbsp;&nbsp;&nbsp;
                          <small>Status:</small> <i class="text-info" >{{$salesOrder->SM_status }}</i> &nbsp;&nbsp;&nbsp;
                          <small>VoucherNo:</small> <i class="text-info" >{{$salesOrder->reference_number }}</i></p>
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                          </button>
                        </div>
                        <div class="modal-body">
                            ...
                            @forelse ($salesOrderDetails as $salesOrderDetail)
                             ...
                             @endphp
                                <div class="row">
                                     <div class="col-3">
                                        <i class="text-info" ><b>{{$salesOrderDetail->item_name}}</b></i>
                                     </div>
                                     <div class="col-3">
                                        {{number_format($salesOrderDetail->quantity)}}
                                     </div>
                                     <div class="col-3">
                                        {{number_format($salesOrderDetail->amount,2)}} ,<small>{{$salesOrderDetail->tax}}%</small>
                                     </div>
                                     <div class="col-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                   <b>Total: &nbsp; <i class="text-info" > {{number_format($salesOrder->grand_total,2) }}</i></b>
                                 </div>
                            </div>
                        </div>
