...
<head>
    ...
    <title>{{ $salesOrder->customer->name }} | Invoice Print</title>
        ...
        <section class="invoice">
            ...
            <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                    From
                    <address>
                        <strong>Inventory, {{ $salesOrder->location->name }}.</strong><br>
                        {{ $salesOrder->location->address }}<br>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            @php
                                ...
                                $total = 0;
                            @endphp
                            @forelse ($salesOrderDetails as $detail)
                                @php
                                    $no = $no + 1;
                                    // $vat = $detail->tax;
