...
<div class="col-md-12">
    <div class="card card-primary card-outline">
      ...
      <div class="row">
          <div class="col-8 lg">
            <div class="pl-3"> <small>Vendors: </small><b> {{ count($vendor) }}</b></div>
          </div>
          <div class="col-4 lg">
                ...
                <div class="container-fluid">
                        <div class="timeline">
                            ...
                            <div class="timeline-item">
                                <span class="time"><i class="fas fa-clock"></i>{{$vendor->created_at->diffForHumans()}}</span>
                                <h3 class="timeline-header no-border"><a href="#">{{$vendor->name}}</a>:
                                 <small>Phone:</small> {{$vendor->phone}} , <small>Company:</small> {{$vendor->company_name}}
                                 <div id="detail_{{$vendor->id}}" style="display:none;">
                                    <small>City</small> {{$vendor->city}} , <small>Email</small> {{$vendor->email}}
                                    <small>Woreda</small> {{$vendor->woreda}} , <small>Kebele</small> {{$vendor->kebele}}
                                 </div>
                                </h3>
                                <div class="timeline-footer">
                                    <a class="btn btn-success btn-xs" href="purcahsePayments-{{$vendor->id}}">Balance</a>
                                    <a class="btn btn-primary btn-xs" href="vendorPurchaseHistory-{{$vendor->id}}" >History</a>
                                    <a class="btn btn-warning btn-xs" data-toggle="modal" data-target="#modal-lg-vendor-{{$vendor->id}}">Edit</a>
                                    <a class="btn btn-danger btn-xs" href="delete-vendor-{{$vendor->id}}" onclick="return confirm('Are you sure you ?');">Delete</a>
                                </div>
                            </div>
                            </div>
                            ...
                            @empty
                            @endforelse
                            {{-- <div class="p-2" style="float: right"> {{ $vendors->links("pagination::bootstrap-4") }}</div> --}}
                        <div>
    ...
    @forelse ($vendors as $vendor )
    <div class="modal fade" id="modal-lg-vendor-{{$vendor->id}}">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit {{$vendor->name}}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form  action="/edit-vendor-{{$vendor->id}}" method="POST" id="quickForm" >
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Full Name</label>
                                            <input type="text" name="name" class="form-control" id="exampleInputEmail1" value={{$vendor->name}} required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1" id='click'> Phone</label>
                                            <input type="text" name="phone" class="form-control" id="exampleInputPassword1" value={{$vendor->phone}} required pattern="[+ , 0]{1}[0-9]{9,14}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1" id='click'> Email <small>Optional</small> </label>
                                            <input type="email" name="email" class="form-control" id="exampleInputPassword1" value={{$vendor->email}}>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Company Name <small>Optional</small> </label>
                                            <input type="text" name="company_name" class="form-control" id="exampleInputPassword1" value={{$vendor->company_name}} >
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">City <small>Optional</small> </label>
                                            <input type="text" name="city" class="form-control" id="exampleInputPassword1" value={{$vendor->city}} >
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Woreda <small>Optional</small> </label>
                                            <input type="text" name="woreda" class="form-control" id="exampleInputPassword1" value={{$vendor->woreda}} >
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Kebele <small>Optional</small> </label>
                                            <input type="text" name="kebele" class="form-control" id="exampleInputPassword1" value={{$vendor->kebele}} >
                                        </div>
                                    </div>
                                </div>
                            </div>
