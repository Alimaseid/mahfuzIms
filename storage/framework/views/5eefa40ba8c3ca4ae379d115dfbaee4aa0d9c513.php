                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="" data-toggle="modal"
                                                            ...
                                                            data-target="#modal-lg-view-<?php echo e($payment->narration); ?>"><?php echo e(number_format($payment->debit, 2)); ?></a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <?php if($payment->debit > 0): ?>
                                                            <i class="fa fa-arrow-up sm" style="color:red"
                                                                data-toggle="modal"
                                                                data-target="#modal-lg-view-<?php echo e($payment->narration); ?>"></i>
                                                        <?php else: ?>
                                                            <i class="fa fa-arrow-down sm" style="color:green"
                                                                data-toggle="modal" style="color: rgb(7, 161, 233)"
                                                                data-target="#modal-lg-edit-<?php echo e($payment->id); ?>"></i>
                                                        <?php endif; ?>
                                                        &nbsp; &nbsp;
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Edit <i
                                                                        class="text-info"><?php echo e($customer); ?>'s
                                                                    </i>Payment.</h4>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="card card-primary">
                                                                                ...
                                                                                <form
                                                                                    action="/editCustomerPayment-<?php echo e($payment->id); ?>"
                                                                                            ...
                                                                                            <div class="col-6">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <select
                                                                                                        ...
                                                                                                        required>
                                                                                                        <option
                                                                                                            value="<?php echo e(Illuminate\Support\Str::before($payment->voucher_type, ',')); ?>">
                                                                                                            <?php echo e(Illuminate\Support\Str::before($payment->voucher_type, ',')); ?>
                                                                                            ...
                                                                                            <div class="col-6">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="number"
                                                                                                        ...
                                                                                                        name="amount"
                                                                                                        class="form-control"
                                                                                                        value="<?php echo e($payment->credit); ?>">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="row">
                                                                                            <div class="col-6">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <select name="bank"
                                                                                                        ...
                                                                                                        id="cheque">
                                                                                                        <option
                                                                                                            value="<?php echo e(Illuminate\Support\Str::after($payment->voucher_type, ',')); ?>">
                                                                                                            <?php echo e(Illuminate\Support\Str::after($payment->voucher_type, ',')); ?>
                                                                                            ...
                                                                                            <div class="col-6">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                        name="cheque_no"
                                                                                                        class="form-control"
                                                                                                        value="<?php echo e($payment->refrence_no); ?>">
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">New payment By <i
                                                class="text-info"><?php echo e($customer); ?></i></h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="card card-primary">
                                                        ...
                                                        <form action="/Payment-<?php echo e($lastBalance->customer_id); ?>"
                                                                    ...
                                                                    <div class="col-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number" step="any"
                                                                                ...
                                                                                value="<?php echo e($lastBalance->running_balance); ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <p>
                                                <small> Date:</small> <i
                                                    class="text-info"><?php echo e($salesOrder->created_at->toDateString()); ?></i>&nbsp;&nbsp;&nbsp;
                                                <small>Status:</small> <i
                                                    class="text-info"><?php echo e($salesOrder->SM_status); ?></i> &nbsp;&nbsp;&nbsp;
                                                <small>VoucherNo:</small> <i
                                                    class="text-info"><?php echo e($salesOrder->reference_number); ?></i>
                                            </p>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            ...
                                            <?php $__empty_2 = true; $__currentLoopData = $salesOrderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesOrderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                <?php if($salesOrderDetail->sales_order_id == $salesOrder->id): ?>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <i
                                                                class="text-info"><b><?php echo e($salesOrderDetail->item_name); ?></b></i>
                                                        </div>
                                                        <div class="col-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3">
                                                    <b>Total: &nbsp; <i class="text-info">
                                                            <?php echo e(number_format($salesOrder->grand_total, 2)); ?></i></b>
                                                </div>
                                            </div>
                                        </div>
