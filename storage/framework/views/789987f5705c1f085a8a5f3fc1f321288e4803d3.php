                    ...
                    <div class="row">
                        <div class="col-12">
                            INVENTORY REPORT On <i class="text-warning" style="font-weight: 800">&nbsp;
                                <?php echo e(Carbon\Carbon::now()->toFormattedDateString()); ?></i>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('inc.frame', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Halima\Documents\ims\resources\views/pages/reports/general_report.blade.php ENDPATH**/ ?>