                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success btn-xs" data-toggle="modal"
                                                data-target="#modal-lg-view-<?php echo e($dt['id']); ?>">View Detail</button>
                                        </td>
                                    </tr>
                                                    ...
                                                    <?php $__empty_2 = true; $__currentLoopData = $dt['Details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchaseOrderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                        <?php if($purchaseOrderDetail['order_id'] == $dt['id']): ?>
                                                            <div class="row">
                                                                ...
                                                                <div class="col">
                                                                    <a
                                                                        href=""><b><?php echo e($purchaseOrderDetail['item_code']); ?></b></a>
                                                                </div>
                                                                <div class="col">
                                                                    <a
                                                                        href=""><b><?php echo e($purchaseOrderDetail['part_number']); ?></b></a>
                                                                </div>
                                                                <div class="col">
                                                                    <a
                                                                        href=""><b><?php echo e($purchaseOrderDetail['unit']); ?></b></a>
                                                                </div>
                                                                <div class="col">
                                                                    <a
                                                                        href=""><b><?php echo e($purchaseOrderDetail['category']); ?></b></a>
                                                                </div>
                                                                <div class="col">
                                                                    <a
                                                                        href=""><b><?php echo e($purchaseOrderDetail['shelf']); ?></b></a>
                                                                </div>
                                                                <div class="col">
                                                                ...
                                                                <div class="col">
                                                                    <?php echo e(number_format($purchaseOrderDetail['total'])); ?>
...
<?php echo $__env->make('inc.frame', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Halima\Documents\ims\resources\views/pages/customers/customerSalesHistory.blade.php ENDPATH**/ ?>