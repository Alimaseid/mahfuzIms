                                        ...
                                        <td>
                                            <?php if($imagePath): ?>
                                                <img src="<?php echo e(asset($imagePath)); ?>"
                                                    ...
                                                    onclick="setModalImage('<?php echo e(asset($imagePath)); ?>')" data-toggle="modal"
                                        ...
                                        <td>
                                            <?php if($imagePath2): ?>
                                                <img src="<?php echo e(asset($imagePath2)); ?>"
                                                    style="width:50px; height:50px; object-fit:cover;"
                                                    onclick="setModalImage('<?php echo e(asset($imagePath2)); ?>')" data-toggle="modal"
                                                    data-target="#imageModal">
                                            <?php endif; ?>
                                        </td>
...
<?php echo $__env->make('inc.frame', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Halima\Documents\ims\resources\views/pages/reports/transfer_warehouse_item.blade.php ENDPATH**/ ?>