                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-8 lg">
                                    <div class="pl-3"> <small>TotalOrders: </small><b> <?php echo e(count($purchaseOrders)); ?></b>
                                    </div>
                                        ...
                                        <tr>
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title"><?php echo e($purchaseOrder->reference_number); ?>
                                                            ...
                                                            <?php $__empty_1 = true; $__currentLoopData = $purchaseOrderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchaseOrderDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                <?php if($purchaseOrderDetail->purchase_order_id == $purchaseOrder->id): ?>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-3">
                                                                            <a
                                                                                href=""><b><?php echo e($purchaseOrderDetail->item_name); ?></b></a>
                                                                        </div>
                                                                        <div class="col-3">
                                                                        ...
                                                                        <div class="col-3">
                                                                            <?php echo e(number_format($purchaseOrderDetail->amount)); ?>

                                                                            ,<small><?php echo e($purchaseOrderDetail->tax); ?>%</small>
                                                                        </div>
                                                                        <div class="col-3">
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-success btn-xs" data-toggle="modal"
                                                    data-target="#modal-lg-view-<?php echo e($purchaseOrder->id); ?>">
                                                    ViewDetails
                                                </button>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-primary btn-xs" data-toggle="modal"
                                                    data-target="#modal-lg-edit<?php echo e($purchaseOrder->id); ?>">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <a type="button" class="btn btn-danger btn-xs"
                                                    href="delete-purchase-order-<?php echo e($purchaseOrder->id); ?>"
                                                                                                ...
                                                                                                <ul class="nav nav-pills nav-sidebar flex-column"
                                                                                                    ...
                                                                                                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                                                        <option
                                                                                                            ...
                                                                                                            onclick="selectedItem(<?php echo e($item->id); ?>,0)">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $purchaseOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchaseOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="modal fade" id="modal-lg-edit<?php echo e($purchaseOrder->id); ?>">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Edit GoodReceiving <?php echo e($purchaseOrder->id); ?></h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                    ...
                                    <section class="content">
                                        <div class="container-fluid">
                                            <div class="row">
                                                <div class="col-12">
                                                    <form method="POST"
                                                        action="editPurchaseOrder-<?php echo e($purchaseOrder->id); ?>">
                                                        <?php echo csrf_field(); ?>
                                                        <!-- Main content -->
                                                        <div class="invoice p-3 mb-3">
                                                            <!-- title row -->
                                                                ...
                                                                <div class="col-12">
                                                                    <h4>
                                                                        ...
                                                                        <small class="float-right">Good Receiving Date :
                                                                            <?php echo e($purchaseOrder->created_at->toFormattedDateString()); ?></small>
                                                                    </h4>
                                                                </div>
                                                                <!-- /.col -->
                                                            </div>
                                                            ...
                                                            <div class="row invoice-info">
                                                                        ...
                                                                        <select name="business_location"
                                                                            ...
                                                                            <?php $__empty_2 = true; $__currentLoopData = $businessLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $businessLocation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                                                <?php if($purchaseOrder->business_location == $businessLocation->id): ?>
                                                                                    <option
                                                                                        value="<?php echo e($purchaseOrder->business_location); ?>">
                                                                                        <?php echo e($businessLocation->name); ?>
                                                                        ...
                                                                        <select name="owner" class="form-control"
                                                                            ...
                                                                            <?php $__empty_2 = true; $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                                                <?php if($purchaseOrder->owner == $owner->id): ?>
                                                                                    <option
                                                                                        value="<?php echo e($purchaseOrder->owner); ?>">
                                                                                        <?php echo e($owner->name); ?> </option>
                                                                                <?php endif; ?>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_2): ?>
                                                                            <?php endif; ?>
                                                                ...
                                                                <div class="col-sm-5 invoice-col">
                                                                    ...
                                                                    <input type="text" name="refrence_no"
                                                                        ...
                                                                        value=" <?php echo e($purchaseOrder->reference_number); ?>">
                                                                                ...
                                                                                <?php if($purchaseOrderDetail->purchase_order_id == $purchaseOrder->id): ?>
                                                                                    <tr id="">
                                                                                                ...
                                                                                                <div class="dropdown">
                                                                                                    <div id="myDropdown_0"
                                                                                                        ...
                                                                                                        <input
                                                                                                            ...
                                                                                                            autoComplete="off"
                                                                                                            readonly
                                                                                                            value="<?php echo e($purchaseOrderDetail->item_name); ?>"
                                                                                                            placeholder="Search.."
                                                                                                            id="myInput_0"
                                                                                                            onclick="myFunction(0)"
                                                                                                            onkeyup="filterFunction(0)"
                                                                                                            name="addmore[<?php echo e($no); ?>][search_item]"
                                                                                                            class="form-control"
                                                                                                            required>
                                                                                                        <div id="items_0"
                                                                                                            style="display: none">
                                                                                                            <ul class="nav nav-pills nav-sidebar flex-column"
                                                                                                                ...
                                                                                                                <input
                                                                                                                    type="hidden"
                                                                                                                    id="item_id_0"
                                                                                                                    value="<?php echo e($purchaseOrderDetail->item_id); ?>"
                                                                                                                    name="addmore[<?php echo e($no); ?>][item_id]">
                                                                                                                <ul class="nav nav-pills nav-sidebar flex-column"
                                                                                                                    data-widget="treeview"
                                                                                                                    role="menu"
                                                                                                                    data-accordion="false">
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="number"
                                                                                                id='0'
                                                                                                name="addmore[<?php echo e($no); ?>][quantity]"
                                                                                                value="<?php echo e($purchaseOrderDetail->qunatity); ?>"
                                                                                                class="form-control input-group-sm"
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="number"
                                                                                                id='u_price_0'
                                                                                                name="addmore[<?php echo e($no); ?>][u_price]"
                                                                                                value="<?php echo e($purchaseOrderDetail->amount / $purchaseOrderDetail->qunatity); ?>"
                                                                                                class="form-control input-group-sm"
                                                                                                required>
                                                                                        </td>
                                                                                        ...
                                                                                        <td><input type="text"
                                                                                                id="sub_0"
                                                                                                class="form-control sub"
                                                                                                value="<?php echo e($purchaseOrderDetail->total); ?>"
                                                                                                class="form-control"
                                                                        ...
                                                                        <div class="col-sm-6 invoice-col">
                                                                            <address>
                                                                                ...
                                                                                <input type="date"
                                                                                    name="expected_delivery_date"
                                                                                    class="form-control"
                                                                                    value="<?php echo e($purchaseOrder->expected_delivery_date); ?>">
                                                                        </div>
                                                                        <div class="col-sm-6 invoice-col">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                class="form-control"
                                                                                value="<?php echo e($purchaseOrder->shipment_reference); ?>">
                                                                        </div>
                                                                        </address>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-8">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <select name="payment_type" id=""
                                                                                    class="form-control" required>
                                                                                    <option
                                                                                        value="<?php echo e($purchaseOrder->payment_terms); ?>">
                                                                                        <?php echo e($purchaseOrder->payment_terms); ?>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table class="table">
                                                                            <tr>
                                                                                <th style="width:50%">Subtotal : </th>
                                                                                <td><i
                                                                                        id="sub"></i><?php echo e($purchaseOrder->total_payment - ($purchaseOrder->total_payment * $tax) / 100); ?>

                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <th id="vatRate">
                                                                                    Tax(<?php echo e($tax); ?>%)</th>
                                                                                <td> <i id="vat"></i>
                                                                                    <?php echo e(($purchaseOrder->total_payment * $tax) / 100); ?>
                                                                            ...
                                                                            <tr>
                                                                                <th>Total:</th>
                                                                                <td> <i id="tot"
                                                                                        name='Gtotal'><?php echo e($purchaseOrder->total_payment); ?></i>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </div>
        ...
        <tr>
             <td style="width: 250px;">
                ...
                `" style="display: none">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option class="nav-link" id="item_<?php echo e($item->id); ?>" onclick="selectedItem(<?php echo e($item->id); ?>,` +
                i + `)"><?php echo e($item->item_name); ?> | <?php echo e($item->product_code); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <?php endif; ?>
...
<?php echo $__env->make('inc.frame', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Halima\Documents\ims\resources\views/pages/purchase/purchase.blade.php ENDPATH**/ ?>