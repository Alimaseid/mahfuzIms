                                        ...
                                        <?php if($order->r_status != 'Done'): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-info btn-xs" data-toggle="modal"
                                                        data-target="#modal-lg-custom-<?php echo e($order['id']); ?>">CustomReturn</a>
                                                </td>
                                            </tr>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="card card-primary">
                                                                            ...
                                                                            <form action="/customReturn-<?php echo e($order['id']); ?>"
                                                                                ...
                                                                                <div class="card-body">
                                                                                        ...
                                                                                        <div class="col-4">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <input type="date"
                                                                                                    accept="any"
                                                                                                    name="return_date"
                                                                                                    class="form-control"value="<?php echo e(Carbon\Carbon::now()->toDateString()); ?>"
                                                                                                    required>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-4">
                                                                                        ...
                                                                                        <div class="col-4">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <select class="form-control"
                                                                                                    ...
                                                                                                    <option value="">
                                                                                                        Select</option>
                                                                                                    <?php $__empty_1 = true; $__currentLoopData = $location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                                                        <option
                                                                                    ...
                                                                                    <?php $__currentLoopData = $data['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                        <?php if($item['order_id'] == $order['id']): ?>
                                                                                            <div class="row"
                                                                                                id="remove_<?php echo e($item['item_id']); ?>">
                                                                                                <div class="col-3">
                                                                                                    <div
                                                                                                        class="form-group">
                                                                                                        <label
                                                                                                            ...
                                                                                                            <a
                                                                                                                href=""><?php echo e($item['item_code']); ?></a></label>
                                                                                                        <input
                                                                                                            type="hidden"
                                                                                                            name="addmore[<?php echo e($item['item_id']); ?>][item_id]"
                                                                                                            value="<?php echo e($item['item_id']); ?>">
                                                                                                        <input
                                                                                                            type="hidden"
                                                                                                            name="addmore[<?php echo e($item['item_id']); ?>][price]"
                                                                                                            value="<?php echo e($item['price']); ?>">
                                                                                                        <input
                                                                                                            type="hidden"
                                                                                                            name="addmore[<?php echo e($item['item_id']); ?>][qyt]"
                                                                                                ...
                                                                                                <div class="col-2">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <label
                                                                                                            for="exampleInputPassword1"
                                                                                                            id='click'><?php echo e(number_format($item['price'], 2)); ?></label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                ...
                                                                                                <div class="col-2">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <label
                                                                                                            for="exampleInputPassword1"
                                                                                                            id='click'><?php echo e(number_format($item['quantity'])); ?></label>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-2">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            type="number"
                                                                                                            accept="any"
                                                                                                            name="addmore[<?php echo e($item['item_id']); ?>][remaining]"
                                                                                                            class="form-control"
                                                                                                            min='0'
                                                                                                            max="<?php echo e($item['quantity']); ?>"
                                                                                                            id="exampleInputPassword1"
                                                                                                            value="<?php echo e($item['remaining']); ?>"
                                                                                                            required>
                                                                                                    </div>
                                                                                                ...
                                                                                                <div class="col-2">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            type="number"
                                                                                                            accept="any"
                                                                                                            name="addmore[<?php echo e($item['item_id']); ?>][quantity]"
                                                                                                            class="form-control"
                                                                                                            min='0'
                                                                                                            max="<?php echo e($item['quantity']); ?>"
                                                                                                            id="exampleInputPassword1"
                                                                                                ...
                                                                                                <div class="col-1">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <button
                                                                                                            type="button"
                                                                                                            class=" remove-div_<?php echo e($item['item_id']); ?>"><B
                            ...
                            <table id="example2" class="table table-bordered table-striped"
                                ...
                                <tbody id='list'>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        ...
                                        <tr>
                                            <td><?php echo e($no); ?></td>
                                            <td><?php echo e($return->created_at->year . '/' . $return->created_at->month . '/' . $return->created_at->day); ?>
                                            ...
                                            <td><a class="btn btn-warning btn-xs" data-toggle="modal"
                                                    data-target="#modal-lg-return-<?php echo e($return->id); ?>">Detail</a></td>
                                        </tr>
                                        ...
                                        <div class="modal fade" id="modal-lg-return-<?php echo e($return->id); ?>">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title"><?php echo e($return->created_at->toDateString()); ?>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="card card-primary">
                                                                        ...
                                                                        <form action="/editReturn-<?php echo e($return->id); ?>"
                                                                            method="POST" id="quickForm">
                                                                            <?php echo csrf_field(); ?>
                                                                            <div class="card-body">
                                                                                <div class="row">
                                                                                    <div class="col-4">
                                                                                        <div class="form-group">
                                                                                            <label
                                                                                                ...
                                                                                                Date</label>
                                                                                            <input
                                                                                                type="date"<?php if(true): echo 'readonly'; endif; ?>
                                                                                                accept="any"
                                                                                                value="<?php echo e($return->return_date); ?>"
                                                                                                name="return_date"
                                                                                                class="form-control"
                                                                                                required>
                                                                                    ...
                                                                                    <div class="col-4">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select class="form-control"
                                                                                                ...
                                                                                                required>
                                                                                                <option
                                                                                                    value="<?php echo e($return->refunded_type); ?>">
                                                                                                    <?php echo e($return->refunded_type); ?>
                                                                                    ...
                                                                                    <div class="col-4">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <select class="form-control"
                                                                                                ...
                                                                                                required>
                                                                                                <option
                                                                                                    value="<?php echo e($return->return_to); ?>">
                                                                                                    <?php $__empty_2 = true; $__currentLoopData = $location; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                                                                                            ...
                                                                                            <div class="col-4">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <label
                                                                                                        ...
                                                                                                        <a href="">
                                                                                                            <?php if($it != ''): ?>
                                                                                                                <?php echo e($it->product_code); ?>

                                                                                                            <?php endif; ?>
                                                                                                        </a></label>
                                                                                                    <input type="hidden"
                                                                                                        name="addmore[<?php echo e($item->id); ?>]['item_id']"
                                                                                                        value="<?php echo e($item->id); ?>">
                                                                                                    <input type="hidden"
                                                                                                        name="addmore[<?php echo e($item->id); ?>]['price']"
                                                                                                        value="<?php echo e($item->price); ?>">
                                                                                                    <input type="hidden"
                                                                                                        name="addmore[<?php echo e($item->id); ?>]['qyt']"
                                                                                                        value="<?php echo e($item->quantity); ?>">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-4">
...
<?php echo $__env->make('inc.frame', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Halima\Documents\ims\resources\views/pages/sales/salesReturn.blade.php ENDPATH**/ ?>