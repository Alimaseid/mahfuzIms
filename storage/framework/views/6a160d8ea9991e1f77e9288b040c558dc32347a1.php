                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="form-check">
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    id="manage_image<?php echo e($role->id); ?>"
                                                                                    value="on"
                                                                                    <?php if($role->manage_image == 'on'): echo 'checked'; endif; ?>>
                                                                                <label class="form-check-label"
                                                                                    for="manage_image<?php echo e($role->id); ?>">Manage-Image</label>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="form-check">
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="checkbox"
                                                                                    name="manage_notification"
                                                                                    id="manage_notification<?php echo e($role->id); ?>"
                                                                                    value="on"
                                                                                    <?php if($role->manage_notification == 'on'): echo 'checked'; endif; ?>>
                                                                                <label class="form-check-label"
                                                                                    for="manage_notification<?php echo e($role->id); ?>">M-Notification</label>
                                                                            </div>
                                                                            <div class="form-check">
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    id="manage_price<?php echo e($role->id); ?>"
                                                                                    value="on"
                                                                                    <?php if($role->manage_price == 'on'): echo 'checked'; endif; ?>>
                                                                                <label class="form-check-label"
                                                                                    for="manage_price<?php echo e($role->id); ?>">manage_price</label>
                                                                            </div>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="form-check">
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="checkbox"
                                                                                    name="manage_partNumber"
                                                                                    id="manage_partNumber<?php echo e($role->id); ?>"
                                                                                    value="on"
                                                                                    <?php if($role->manage_partNumber == 'on'): echo 'checked'; endif; ?>>
                                                                                <label class="form-check-label"
                                                                                    for="manage_partNumber<?php echo e($role->id); ?>">Manage-p_No</label>
                                                                            </div>
                                                                        </td>
...
<?php echo $__env->make('inc.frame', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\amarImsfinal\resources\views/pages/user/users.blade.php ENDPATH**/ ?>